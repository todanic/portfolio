...
export default function ExperienceCard({ experience }) {
  ...
  return (
    <div className='relative dark:bg-gray-900 shadow-lg rounded-lg border border-gray-400'>
      <div className='bg-purple-900 flex flex-col relative h-[150px] items-center dark:rounded-l-[10px] dark:rounded-r-[10px]'>
        <h3 className='text-2xl font-bold mt-6 text-white'>{name}</h3>
        <img
          className={
            (whiteBackground ? " bg-white" : "") +
            " w-[200px] absolute bottom-[-20px] left-[50%] translate-x-[-50%]"
          }
          src={image}
          alt={name}
        />
