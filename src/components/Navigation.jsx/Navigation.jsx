...
export function Navigation(props) {
    ...
    return (
       <ul className='m-0 p-0 list-none flex'>
        <li><a className='p-5 dark:hover:bg-darkPurple hover:bg-lightGray dark:hover:text-white transition-all duration-300 ease-in-out' href='#skills'>Skills</a></li>
        <li><a className='p-5 dark:hover:bg-darkPurple hover:bg-lightGray dark:hover:text-white transition-all duration-300 ease-in-out' href='#work'>Work Experiences</a></li>
